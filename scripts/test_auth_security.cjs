...
assert.match(ordersClient, /Invoice state[\s\S]+Paid by[\s\S]+paymentMethodLabel\(quote\.paymentMethod\)/, "printed paid invoices must show the payment method inside the invoice state block");
