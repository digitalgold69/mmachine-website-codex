/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: acfaf1c6d1d636f8ae4db1425e3d9623)
// Runtime types generated with workerd@1.20260611.1 2026-07-11 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	FEATURED_IMAGES: R2Bucket;
	QUOTE_FILES: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	NEXT_PUBLIC_SITE_URL: "https://mmachine-website-codex.muddy-silence-4f5b.workers.dev";
	QUOTE_OWNER_EMAIL: "sales@m-machine.co.uk";
	QUOTE_CUSTOM_OWNER_EMAIL: "sales@m-machine.co.uk";
	QUOTE_MINI_OWNER_EMAIL: "sales@m-machine.co.uk";
	QUOTE_METALS_OWNER_EMAIL: "sales@m-machine.co.uk";
	QUOTE_FEATURED_OWNER_EMAIL: "sales@m-machine.co.uk";
	QUOTE_ENQUIRY_OWNER_EMAIL: "sales@m-machine.co.uk";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "QUOTE_OWNER_EMAIL" | "QUOTE_CUSTOM_OWNER_EMAIL" | "QUOTE_MINI_OWNER_EMAIL" | "QUOTE_METALS_OWNER_EMAIL" | "QUOTE_FEATURED_OWNER_EMAIL" | "QUOTE_ENQUIRY_OWNER_EMAIL">> {}
}
